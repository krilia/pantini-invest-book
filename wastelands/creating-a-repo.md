...
В главе про [подготовку рабочей среды](getting-started.md#setting-up-ide) мы установили IDE **WebStrom** и сделали первичную настройку. Если **WebStrom** был запущен до установки **Git**, выполните перезапуск программы.
...
В левом нижнем углу программы есть надпись **main**, которая обозначает **текущую** ветку репо.
...
{% hint style="info" %}
Чтобы загрузить файл из репозитория **GitHub**, нажмите кнопку **Raw** в панели с содержимым.
{% endhint %}

После помещения файла в директорию проекта через **WebStorm** \(через Ctrl + V\) будет предложено добавить новый файл на контроль **Git**. Соглашаемся, выставив флаг **Don't ask again**:
...
**Remote branch** - это ветка на удалённом сервере, на которую можно переключиться и работать, создав локальную.
