...
Поместите скопированный файл в директорию проекта через **WebStorm** \(Ctrl + V, выделив папку проекта в файловом дереве\); будет предложено добавить новый файл на контроль **Git**. Соглашаемся, выставив флаг **Don't ask again**:
