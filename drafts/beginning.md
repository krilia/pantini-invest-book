...
* Установить оболочку [Cmder](getting-started.md#cmder-installation)
* Разобраться с [репозиторием проекта](../origins/creating-a-repo.md)
* Обзавестись [IDE](getting-started.md#setting-up-ide), т.е. средой разработки
...
Выполняем команду через [cmder](getting-started.md#cmder-installation):
