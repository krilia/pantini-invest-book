...
Вы попадёте в панель управления приложением, база данных будет подключена автоматически. Осталось получить ключи для программного доступа к API **Realm**, которые будет использовать терминал.
