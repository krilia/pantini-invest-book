...
На следуем экране нужно указать адрес личного ресурса, через который будет проходить аутентификация, **Tenant Domain**. Ниже выбираем регион, в котором будет расположен ресурс \(географически близкий к нам\):
