...
В форме регистрации укажите ваши данные, в списке **How are you using MongoDB** выберите вариант **I'm building a new app**.

После отправки формы нас перенесут на страницу, где нужно будет указать название организации, задать имя проекта и выбрать предпочитаемый язык программирования.

Организацию указываем любую. Проект - **ppp**. Язык - **JavaScript**.

![](../.gitbook/assets/image%20%28278%29.png)

На следующей странице выбираем бесплатный вариант \(Shared Clusters\) проекта:

![&#x41D;&#x430;&#x436;&#x438;&#x43C;&#x430;&#x435;&#x43C; Create a cluster](../.gitbook/assets/image%20%28289%29.png)

На следующей странице нужно выбрать облачного провайдера и регион размещения приложения ppp. 

{% hint style="info" %}
Когда вы настраивали приложение Auth0, вы уже выбирали глобальный регион, откуда будет обслуживаться страница аутентификации. Здесь же стоит выбирать регион аналогичным образом - поближе географически.

Можно выполнить сравнительный замер задержки по каждому провайдеру на ресурсе [https://webping.cloud/](https://webping.cloud/)

У меня самый быстрый регион \(из доступных для выбор\) - **Frankfurt** \(eu-central-1\) в облаке **AWS**.
{% endhint %}

![https://webping.cloud/](../.gitbook/assets/image%20%28281%29.png)

Указываем провайдера и регион:
...
Эту часть можно пропустить. Желающие могут продвинуться дальше \(кнопка **Choose a connection method**\) на страницу выбора метода соединения с базой. Там стоит выбрать вариант **Connect using MongoDB Compass**.
...
![&#x41D;&#x430;&#x436;&#x438;&#x43C;&#x430;&#x435;&#x43C; Fill in connection fields individually](../.gitbook/assets/image%20%28283%29.png)

![](../.gitbook/assets/image%20%28279%29.png)

_Если вы пропустили бонусную часть, посвящённую MongoDB Compass, продолжайте с этого места_. На текущий момент у нас есть кластер, создан IP-адрес для подключения, добавлен пользователь-администратор. Теперь мы подключим сервисы **MongoDB Realm**, создав приложение в рамках проекта **ppp**. Переключайтесь на вкладку **Realm** и заполняйте имя приложения, а также выбирайте среду **Production** как на картинке ниже:

![&#x41D;&#x430;&#x436;&#x438;&#x43C;&#x430;&#x435;&#x43C; Create Realm Application](../.gitbook/assets/image%20%28282%29.png)

Вы попадёте в панель управления приложением, база данных будет подключена автоматически. Теперь необходимо получить ключи для программного доступа к API **Realm**, которые будет использовать терминал.
